...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { business_id: @reward.business_id, customer_id: @reward.customer_id, redeemed: @reward.redeemed, redeemed_at: @reward.redeemed_at, reward: @reward.reward }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { business_id: @reward.business_id, customer_id: @reward.customer_id, redeemed: @reward.redeemed, redeemed_at: @reward.redeemed_at, reward: @reward.reward }
    assert_redirected_to reward_path(assigns(:reward))
  end
