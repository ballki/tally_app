...
class VisitsControllerTest < ActionController::TestCase
  ...
  test "should create visit" do
    assert_difference('Visit.count') do
      post :create, visit: { business_id: @visit.business_id, customer_id: @visit.customer_id }
    end
  ...
  test "should update visit" do
    patch :update, id: @visit, visit: { business_id: @visit.business_id, customer_id: @visit.customer_id }
    assert_redirected_to visit_path(assigns(:visit))
  end
